  ...
  head: () => ({
    meta: [
      ...
      { title: "Mihir Prajapati — Civil Estimator | Ontario, CA" },
      {
        name: "description",
        content:
          "Portfolio of Mihir Prajapati — Civil Estimator, Quantity Surveyor & Project Coordinator. Structural steel estimation, CISC/AISC compliance, multi-million-dollar project delivery.",
      },
      { name: "author", content: "Mihir Prajapati" },
